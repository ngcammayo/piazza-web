...
class UsersTest < ApplicationSystemTestCase
  test "new user can sign up" do
    ...
    fill_in User.human_attribute_name(:password_confirmation), with: "notmatched"
    click_on I18n.t("users.new.sign_up")
    assert_selector "p.is-danger", text: I18n.t("activerecord.errors.models.user.attributes.password_confirmation.confirmation")
